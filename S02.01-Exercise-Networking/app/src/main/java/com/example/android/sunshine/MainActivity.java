...
public class MainActivity extends AppCompatActivity {
    ...
    public class WeatherQueryTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                String weatherSearchResult = NetworkUtils.getResponseFromHttpUrl(weatherRequestURL);
                String[] simpleJsonWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherSearchResult);
