...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // mProgressBar (7) Find the TextView for the error message using findViewById
        mErrorMessageTextView = (TextView)findViewById(R.id.tv_error_message);

        // mProgressBar (17) Find the ProgressBar using findViewById
        mProgressBar = (ProgressBar)findViewById(R.id.pb_load_data);
